...
set_property PACKAGE_PIN T22 [get_ports {result[1]}];  # LD0
set_property PACKAGE_PIN T21 [get_ports {result[0]}];  # LD1
...
# Asign to vector B
set_property PACKAGE_PIN F21 [get_ports {b[0]}];  # SW3
set_property PACKAGE_PIN H19 [get_ports {b[1]}];  # SW4
set_property PACKAGE_PIN H18 [get_ports {b[2]}];  # SW5
