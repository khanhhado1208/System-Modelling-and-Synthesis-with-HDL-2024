...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "pulse_detector.autotvin.dat"
	set constFileTvOut       "pulse_detector.autotvout.dat"
	set constFileHdlTvIn     "pulse_detector.autohdltvin.dat"
	set constFileHdlTvOut    "pulse_detector.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
