...
`define AUTOTB_DUT      pulse_detector
`define AUTOTB_DUT_INST AESL_inst_pulse_detector
`define AUTOTB_TOP      apatb_pulse_detector_top
`define AUTOTB_LAT_RESULT_FILE "pulse_detector.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "pulse_detector.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_pulse_detector_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00
`define AUTOTB_II 1
`define AUTOTB_LATENCY 0

`define AESL_DEPTH_pulse 1
`define AESL_DEPTH_reset 1
`define AESL_DEPTH_out_r 1
`define AUTOTB_TVIN_pulse  "../tv/cdatafile/c.pulse_detector.autotvin_pulse.dat"
`define AUTOTB_TVIN_reset  "../tv/cdatafile/c.pulse_detector.autotvin_reset.dat"
`define AUTOTB_TVIN_pulse_out_wrapc  "../tv/rtldatafile/rtl.pulse_detector.autotvin_pulse.dat"
`define AUTOTB_TVIN_reset_out_wrapc  "../tv/rtldatafile/rtl.pulse_detector.autotvin_reset.dat"
`define AUTOTB_TVOUT_out_r  "../tv/cdatafile/c.pulse_detector.autotvout_out_r.dat"
`define AUTOTB_TVOUT_out_r_out_wrapc  "../tv/rtldatafile/rtl.pulse_detector.autotvout_out_r.dat"
module `AUTOTB_TOP;
...
// The signal of port pulse
reg [0: 0] AESL_REG_pulse = 0;
assign pulse = AESL_REG_pulse;
initial begin : read_file_process_pulse
    integer fp;
    integer err;
    integer ret;
    integer proc_rand;
    ...
    transaction_idx = 0;
    wait(AESL_reset === 0);
    fp = $fopen(`AUTOTB_TVIN_pulse,"r");
    if(fp == 0) begin       // Failed to open file
        $display("Failed to open file \"%s\"!", `AUTOTB_TVIN_pulse);
    ...
    while (token != "[[[/runtime]]]") begin
        ...
        if(token != "[[/transaction]]") begin
            ret = $sscanf(token, "0x%x", AESL_REG_pulse);
              if (ret != 1) begin
