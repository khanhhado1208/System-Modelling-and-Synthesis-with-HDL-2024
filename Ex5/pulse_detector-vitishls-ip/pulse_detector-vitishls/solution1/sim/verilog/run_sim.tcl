...
if {[file isfile pulse_detector.autotvin.dat]} {
	file delete -force pulse_detector.autotvin.dat
}

if {[file isfile pulse_detector.autotvout.dat]} {
	file delete -force pulse_detector.autotvout.dat
}
