...
$(ObjDir)/pulse_detector-tb.cpp_pre.cpp.tb.o : pulse_detector-tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling pulse_detector-tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/pulse_detector.cpp_pre.cpp.tb.o : pulse_detector.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling pulse_detector.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
