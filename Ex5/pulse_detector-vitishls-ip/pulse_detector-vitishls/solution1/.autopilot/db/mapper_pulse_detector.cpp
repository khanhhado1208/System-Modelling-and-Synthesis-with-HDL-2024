...
using hls::sim::Byte;
extern "C" void pulse_detector(char, char, volatile void *);
extern "C" void apatb_pulse_detector_hw(char __xlx_apatb_param_pulse, char __xlx_apatb_param_reset, volatile void * __xlx_apatb_param_out_r) {
using hls::sim::createStream;
  // DUT call
  pulse_detector(__xlx_apatb_param_pulse, __xlx_apatb_param_reset, __xlx_apatb_param_out_r);
}
