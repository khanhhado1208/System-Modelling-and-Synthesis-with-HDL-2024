...
// wrapc file define:
#define AUTOTB_TVIN_input_r "../tv/cdatafile/c.pulse_generator.autotvin_input_r.dat"
#define AUTOTB_TVOUT_input_r "../tv/cdatafile/c.pulse_generator.autotvout_input_r.dat"
#define AUTOTB_TVIN_pulse "../tv/cdatafile/c.pulse_generator.autotvin_pulse.dat"
#define AUTOTB_TVOUT_pulse "../tv/cdatafile/c.pulse_generator.autotvout_pulse.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_pulse "../tv/rtldatafile/rtl.pulse_generator.autotvout_pulse.dat"
...
extern "C"
void pulse_generator_hw_stub_wrapper(hls::sim::Byte<1>, void*);

extern "C"
void apatb_pulse_generator_hw(hls::sim::Byte<1> __xlx_apatb_param_input_r, void* __xlx_apatb_param_pulse)
{
  ...
  static hls::sim::Register port1 {
    ...
    .width = 1,
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_pulse),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_pulse),
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_pulse),
#endif
  };
  port1.param = __xlx_apatb_param_pulse;
  ...
  try {
    ...
    pulse_generator_hw_stub_wrapper(__xlx_apatb_param_input_r, __xlx_apatb_param_pulse);
