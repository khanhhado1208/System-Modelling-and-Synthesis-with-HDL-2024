...
using hls::sim::Byte;
extern "C" void pulse_generator(char, volatile void *);
extern "C" void apatb_pulse_generator_hw(char __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_pulse) {
using hls::sim::createStream;
  // DUT call
  pulse_generator(__xlx_apatb_param_input_r, __xlx_apatb_param_pulse);
}
