...
#
#  17 April 2014
#     Pin constraint for toge switch SW7 was corrected to M15 location.
#
#  16 April 2015
...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {candy_out}];  # "LD0"
set_property PACKAGE_PIN T21 [get_ports {nickel_out}];  # "LD1"
set_property PACKAGE_PIN U22 [get_ports {dime_out}];  # "LD2"
set_property PACKAGE_PIN U21 [get_ports {LD3}];  # "LD3"
set_property PACKAGE_PIN V22 [get_ports {dime_out1}];  # "LD4"
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN P16 [get_ports {ap_rst}];  # "BTNC"
set_property PACKAGE_PIN R16 [get_ports {nickel_in}];  # "BTND"
set_property PACKAGE_PIN N15 [get_ports {dime_in}];  # "BTNL"
set_property PACKAGE_PIN R18 [get_ports {quater_in}];  # "BTNR"
set_property PACKAGE_PIN T18 [get_ports {thanks_in}];  # "BTNU"
