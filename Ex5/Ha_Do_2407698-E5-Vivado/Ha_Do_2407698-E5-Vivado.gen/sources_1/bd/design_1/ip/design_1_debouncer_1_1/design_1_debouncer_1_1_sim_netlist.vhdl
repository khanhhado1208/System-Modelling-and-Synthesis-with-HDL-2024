...
-- Command     : write_vhdl -force -mode funcsim -rename_top design_1_debouncer_1_1 -prefix
--               design_1_debouncer_1_1_ design_1_debouncer_0_5_sim_netlist.vhdl
...
entity design_1_debouncer_1_1_debouncer is
  port (
    ap_clk : in STD_LOGIC;
    ap_rst : in STD_LOGIC;
...
end design_1_debouncer_1_1_debouncer;

architecture STRUCTURE of design_1_debouncer_1_1_debouncer is
  signal counter : STD_LOGIC_VECTOR ( 63 downto 18 );
  ...
  signal \counter[18]_i_10_n_0\ : STD_LOGIC;
  signal \counter[18]_i_11_n_0\ : STD_LOGIC;
  ...
  signal \counter[18]_i_8_n_0\ : STD_LOGIC;
  signal \counter[18]_i_9_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \counter[18]_i_10\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \counter[18]_i_11\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \counter[18]_i_2\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \counter[18]_i_6\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \counter[18]_i_7\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \counter[18]_i_8\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \counter[18]_i_9\ : label is "soft_lutpair0";
...
\counter[18]_i_10\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\counter[18]_i_11\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\counter[18]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\counter[18]_i_6\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
\counter[18]_i_7\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"26"
    )
        port map (
...
\counter[18]_i_8\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\counter[18]_i_9\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_debouncer_1_1 is
  port (
    ap_clk : in STD_LOGIC;
    ap_rst : in STD_LOGIC;
    btn_in : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of design_1_debouncer_1_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_debouncer_1_1 : entity is "design_1_debouncer_0_5,debouncer,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_debouncer_1_1 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of design_1_debouncer_1_1 : entity is "HLS";
  attribute x_core_info : string;
  attribute x_core_info of design_1_debouncer_1_1 : entity is "debouncer,Vivado 2023.1";
end design_1_debouncer_1_1;

architecture STRUCTURE of design_1_debouncer_1_1 is
...
begin
U0: entity work.design_1_debouncer_1_1_debouncer
     port map (
      ap_clk => ap_clk,
      ap_rst => '0',
      btn_in(0) => btn_in,
